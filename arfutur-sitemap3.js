// ---------------------------------------------------
// BLOGTOC BY : https://arab-futur.blogspot.com/
// ---------------------------------------------------
...
// Url: https://arab-futur.blogspot.com/
// Version: 2
// Date: 2018-05-24
// ---------------------------------------------------
// Modified by Aneesh 
         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title=" انقر هنا لتحديد كافة المواضيع في قسم \'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
...
// this function creates a three-column table and adds it to the screen
   ...
   if (postFilter != '') {
      tocTool3 = 'انقر ل عرض كل المواضيع';
   }
   tocTable += '<table>';
   tocTable += '<tr>';
